 ...
 * @param goalName stable goal name
 ...
 */
public record FailureReport(UUID executionId, String goalName, Instant startedAt, Duration duration,
    ...
    public FailureReport {
        ...
        if (goalName.isBlank()) throw new IllegalArgumentException("Blank goalName name");
